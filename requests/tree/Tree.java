...
class Tree implements Serializable 
{
 	...
 	public void iniRoot(String id, String name) 
  {
    ...
    rootNode = newNode;
 	...
 	public String addChild (String id, String name, String root) 
  {
 		if (names.get(id) != null) 
    {
 			return "Error: id is busy!";
 		}
 		...
 		if (parent == null) 
    {
 			return "Error: the parent does not exist!";
 		}
  ...
  public String getFullInf(String id) 
  {
  	...
  	if (node == null)
    {
      return "Error: the company with the id \"" + id + "\" was not found!";
    }
